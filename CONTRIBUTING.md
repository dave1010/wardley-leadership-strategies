...
- Use the `<BookRef isbn="9781234567890" />` component when referencing a book inside MDX content. The component resolves the ISBN against the site-wide books index generated by `plugins/books-index/index.js`, so you don't need to import it manually.
