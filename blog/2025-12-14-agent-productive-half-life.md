...
Leaders keep asking a version of the same question: *how long can an agent run before a human needs to step in?* Call that interval the **productive half-life**. It is the period where an AI agent stays useful, safe, and aligned without direct oversight. There is solid research behind this framing. [METR’s time-horizon studies](https://metr.org/blog/2025-03-19-measuring-ai-ability-to-complete-long-tasks/) estimate task duration at 50% reliability across domains. [OSWorld](https://os-world.github.io/), [RealWebAssist](https://arxiv.org/abs/2404.07972), TOOLATHLON, and [SWE-bench Verified](https://openai.com/index/introducing-swe-bench-verified/) test long, messy task chains rather than isolated steps. Human-automation trust work ([Lee & See](https://csel.eng.ohio-state.edu/productions/intel/research/trust/Lee%20%26%20See%20Trust%20Review.pdf); [CHI 2019 Guidelines for Human–AI Interaction](https://www.microsoft.com/en-us/research/project/guidelines-for-human-ai-interaction/)) plus mixed-initiative research ([Horvitz](https://erichorvitz.com/chi99horvitz.pdf); [Hearst](https://www.microsoft.com/en-us/research/wp-content/uploads/2016/11/mixedinit.pdf); [Bradshaw](https://www.jeffreymbradshaw.net/publications/Dimensions%20chapter.pdf)) also helps teams decide when people should re-enter the loop.
...
AI agents now do more than narrow automation tasks. They draft policies, sequence experiments, and orchestrate workflows. But raw capability without a measure of sustainable autonomy is risky. METR’s horizon results provide a capability ceiling: roughly how long a model can go before success drops below 50%. Benchmarks like OSWorld and RealWebAssist show where that ceiling breaks under GUI ambiguity or changing instructions. Half-life converts this into an operational metric: how many minutes, hours, or days pass before drift, ambiguity, or error accumulation requires human intervention.
...
The goal is not to remove humans from the loop. The goal is to place human attention at the moments that matter most. Productive half-life gives teams a shared language for that tradeoff. As agents improve, the organisations that benefit most will be the ones that extend autonomy safely and define clear handoff points before incidents force the issue.
