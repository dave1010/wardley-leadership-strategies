...
- [*The Innovator's Dilemma* by Clayton M. Christensen](https://www.hbs.edu/faculty/Pages/item.aspx?num=46) - This book explains how disruptive innovations, often initially dismissed by incumbents, can overturn established leaders, a dynamic often exploited in a Fool's Mate.
- [*The Black Swan: The Impact of the Highly Improbable* by Nassim Nicholas Taleb](https://www.penguinrandomhouse.com/books/288003/the-black-swan-by-nassim-nicholas-taleb/) - While not directly about strategy, Taleb's work on unexpected, high-impact events is relevant to understanding the mindset required to both see and execute (or be vulnerable to) a Fool's Mate, which often appears as a 'black swan' event to the unprepared competitor.
