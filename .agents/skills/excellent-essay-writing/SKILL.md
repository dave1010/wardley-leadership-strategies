...
Good essays do one thing well: they answer a real question with clear evidence. This playbook keeps you focused while you draft and revise.
...
- Revisit the question after each draft. If a paragraph does not help answer it, cut or rewrite.
...
- Keep the thesis visible while drafting. Every paragraph should help prove it.

## 3. Structure Like a Funnel
- **Introduction:** Set context, pose the question, and state the thesis.
- **Body:** Organise two to four major points. Each point should support the thesis from a different angle.
- **Conclusion:** Restate the thesis based on the evidence, then explain why it matters.
...
- **Explanation:** Analyse the evidence. Explain the mechanism, significance, or causal link.
...
- Use topic sentences and short paragraph summaries to keep the reader oriented.
...
- Keep tone consistent: professional, clear, and free from filler.
...
- Counterarguments show command of the topic and make your conclusion more convincing.
